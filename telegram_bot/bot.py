...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.info(f"/start received from {update.effective_user.username}")
    await update.message.reply_text("Welcome to MedAether!", reply_markup=main_keyboard)
...
async def handle_health_consultation(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        error_message = "🧠 I'm currently unable to access advanced medical advice due to system limits.Here’s a general tip: stay hydrated, rest well, and consult a healthcare professional for serious symptoms.⚠️ Important: This is general health information only. Always consult healthcare professionals for medical diagnosis and treatment."
